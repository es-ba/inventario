...
export function movimientos_solicitudes(context:TableContext):TableDefinition{
    ...
    return {
        ...
        fields:[
            {name:'acta'                        , typeName:'bigint'  , nullable:true, editable:false, title:'N.º de solicitud',
                sequence:{name:'acta', firstValue:1}},
            ...
            {name:'responsable'                 , typeName:'text'    , nullable:true, title:'responsable directo'},
