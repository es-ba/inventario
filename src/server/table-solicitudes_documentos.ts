...
export function solicitudes_documentos(_context:TableContext):TableDefinition{
    return {
        ...
        fields:[
            {name:'acta'              , typeName:'bigint'   , nullable:false, editable:false, title:'N.º de solicitud'},
            ...
            {name:'firmante_declarado', typeName:'text'     , nullable:true , editable:false,
                title:'firmante declarado (no validado)'},
            {name:'resultado_recepcion', typeName:'text'     , nullable:true , editable:false,
                title:'resultado de recepción'},
